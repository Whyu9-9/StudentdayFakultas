...
@section('content')
    ...
    <h2 class="mb-4"><i class="fa fa-print"></i> Unduh Berkas</h2>
    ...
    <div class="alert alert-success">
        ...
        <i class="fa fa-check-circle"></i> Verifikasi Ulang Berhasil. Berkas siap untuk diunduh.<br>
    ...
    <div class="card">
        ...
        <div class="card-body">
			...
			<tr>
                        ...
                        <td>Ketentuan Cetak Buku Panduan Student Day</td>
