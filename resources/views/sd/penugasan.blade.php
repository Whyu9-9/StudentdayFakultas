                            ...
                            <td bgcolor="#010000" align="center" style="padding: 20px 30px 40px 30px; color: #c3862d; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
                                ...
                                <p id="tugas"> Silahkan Melakukan Pengumpulan Penugasan dengan Menekan Tombol dibawah ini <br><br> 
                                    ...
                                    @if ($datecond != 0)
                                        ...
                                        <a id="tugas1" style="border-radius:7px;background-color:#c3862d ;border: none;color: white;padding: 10px 20px;text-align: center;text-decoration: none;display: inline-block;font-size: 15px;" href="https://bit.ly/PenugasanSDFT2020">Penugasan</a>

                                        <a id="tugas2" style="border-radius:7px;margin-left:10px;background-color:#c3862d ;border: none;color: white;padding: 10px 20px;text-align: center;text-decoration: none;display: inline-block;font-size: 15px;" href="https://bit.ly/ResumeSDFT2020">Resume</a>

                                        <a id="tugas3" style="border-radius:7px;margin-left:10px;background-color:#c3862d ;border: none;color: white;padding: 10px 20px;text-align: center;text-decoration: none;display: inline-block;font-size: 15px;" href="http://bit.ly/ResumePengenalanSDFT2020">Resume Pengenalan</a>
                        ...
                        <tr>
                            ...
                            <td bgcolor="#fff" align="center" style="padding: 20px 30px 40px 30px; color: #010000; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
                                ...
                                <p id="khusus1"> Silahkan Melakukan Pengumpulan Penugasan Khusus Dengan Menekan Tombol dibawah ini <br><br> 
                                    ...
                                    <a id="khusus" style="background-color:#010000 ;border: none;color: white;padding: 10px 20px;text-align: center;text-decoration: none;display: inline-block;font-size: 15px;" href="https://bit.ly/TugasKhususVerifikasiSDFT2020">Link Google Form</a>
