...
@section('content')
    ...
    <h2 class="mb-4"><i class="fa fa-user"></i> Lembaga</h2>
...
.myIframe iframe {
    ...
    <div class="card-group" style="width:100%;">
        ...
        <div class="card text-white" style="background-color:#010000;margin-right: 10px;">
            ...
            <a data-toggle="modal" data-target="#youtube" class="btn btn-block" data-youtube="{{ $lembaga->link }}" class="stretched-link">

                <img style="width: auto ;max-width: 100% ;height: auto ; display: block;margin-left: auto;margin-right: auto;" class="card-img-top" src="{{asset('/public/'.$lembaga->gambar)}}" alt="Card image" style="width:100%">

                </a>

            <div class="card-body">

              <h4 align="center" class="card-title"><strong>{{$lembaga->nama}}</strong></h4>
