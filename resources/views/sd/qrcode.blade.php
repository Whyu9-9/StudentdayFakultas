            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                <tr>
                    <td bgcolor="#010000" align="center" style="padding: 20px 30px 40px 30px; color: #d8a547; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
                        <img src="{{url('/img/qrcode/mala.png')}}" alt="" style="max-height: 600px">
                        <p>atau</p>
                        <p>Klik <a style="background-color:goldenrod;border: none;color: white;padding: 5px 12px;text-align: center;text-decoration: none;display: inline-block;font-size: 15px;" href="{{ route('beranda-sd-qrcode-link') }}">Tombol</a> berikut untuk masuk ke grup.</p>
                            ...
                            <tr>
                                <td bgcolor="#fff" align="center" style="padding: 20px 30px 40px 30px; color: #c3862d; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 15px; font-weight: 400; line-height: 25px;">
                                    ...
                                    @if($user->program_studi == 6)
                                        <img src="{{url('/img/qrcode/tekniklingkungan2020.png')}}" alt="" style="max-height: 600px">
                                    @elseif($user->program_studi == 7)
                                        <img src="{{url('/img/qrcode/teknikindustri2020.png')}}" alt="" style="max-height: 600px">
                                    @endif
                                    <p>atau</p>
                                    <p>Klik <a style="background-color:goldenrod;border: none;color: white;padding: 5px 12px;text-align: center;text-decoration: none;display: inline-block;font-size: 15px;" href="{{ route('beranda-sd-qrcode-link') }}">Tombol</a> berikut untuk masuk ke grup.</p>
                                    <p>
                        ...
                        <tr>
                            <td bgcolor="#010000" align="center" style="padding: 20px 30px 40px 30px; color: #d8a547; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
                                    @if ($user->program_studi == 1)
                                        <img src="{{url('/img/qrcode/teknikarsitektur2020.png')}}" alt="" style="max-height: 600px">
                                    @elseif($user->program_studi == 2)
                                        <img src="{{url('/img/qrcode/tekniksipil2020.png')}}" alt="" style="max-height: 600px">
                                    @elseif($user->program_studi == 3)
                                        <img src="{{url('/img/qrcode/teknikelektro2020.png')}}" alt="" style="max-height: 600px">
                                    @elseif($user->program_studi == 4)
                                        <img src="{{url('/img/qrcode/teknikmesin2020.png')}}" alt="" style="max-height: 600px">
                                    @elseif($user->program_studi == 5)
                                        <img src="{{url('/img/qrcode/teknologiinformasi2020.png')}}" alt="" style="max-height: 600px">
                                    @endif
                                    <p>atau</p>
                                    <p>Klik <a style="background-color:goldenrod;border: none;color: white;padding: 5px 12px;text-align: center;text-decoration: none;display: inline-block;font-size: 15px;" href="{{ route('beranda-sd-qrcode-link') }}">Tombol</a> berikut untuk masuk ke grup.</p>
